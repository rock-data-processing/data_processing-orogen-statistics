...
namespace statistics {
     ...
     * Provides statistics of data for a given time range.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','statistics::WindowedTask')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for WindowedTask
        ...
        /** Default deconstructor of WindowedTask
         */
	~WindowedTask();
