...
namespace statistics {
     ...
     * Provides cumulative statistics of data feed into this component. Automatically creates Stats ports for each vector.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','statistics::CumulativeTask')
     end
     \endverbatim
    ...
    public:
        /** TaskContext constructor for CumulativeTask
        ...
        /** Default deconstructor of CumulativeTask
         */
	~CumulativeTask();
